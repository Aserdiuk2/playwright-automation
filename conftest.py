...
from page_objects.application_page import App
...
@fixture(scope='session', params=['iPhone 11'])
...
def pytest_addoption(parser):
    ...
    parser.addini('db_path', help='path to sqlite ds file', default='C:\\Users\\Alex\\PycharmProjects\\TestMe-TCM\\db.sqlite3')
